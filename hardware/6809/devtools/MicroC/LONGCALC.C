...
/*
 * Convert a LONG number into an ASCII string
 * Returns pointer to zero terminating destination string
 */
char *ltoa(string, n1, base)
...
/*
 * Convert ASCII string into a LONG number
 * Returns character terminating conversion.
 */
char atol(string, n1, base)
	 unsigned char *string, *n1, base;
{
	unsigned char c;
...
next1:			/* Continue processing a number */
	...
	*ptr = 0;							/* Zero terminate */
	atol(buffer, temp2, 10);			/* Get LONG value for operation */
